/*
 ...
 Source Schema         : eolinker_local

 Target Server Type    : MySQL
 Target Server Version : 50605
 File Encoding         : 65001

 Date: 29/12/2020 21:03:58
*/
...
CREATE TABLE `eo_api`  (
  ...
  `apiFailureMock` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `apiSuccessMock` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  ...
  `apiUpdateTime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `groupID` int(11) UNSIGNED NOT NULL,
  `projectID` int(11) UNSIGNED NOT NULL,
  `starred` tinyint(4) UNSIGNED NOT NULL DEFAULT 0,
  `removed` tinyint(4) UNSIGNED NOT NULL DEFAULT 0,
  `removeTime` timestamp(0) NULL DEFAULT NULL,
  `apiNoteType` tinyint(4) UNSIGNED NOT NULL DEFAULT 0,
  `apiNoteRaw` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `apiNote` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `apiRequestParamType` tinyint(4) UNSIGNED NOT NULL DEFAULT 0,
  `apiRequestRaw` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `updateUserID` int(11) NOT NULL DEFAULT 0,
  `mockRule` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `mockResult` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `mockConfig` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `apiSuccessStatusCode` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '200',
  `apiFailureStatusCode` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '200',
  `beforeInject` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `afterInject` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `apiMethodType` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `apiMethod` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
...
CREATE TABLE `eo_api_env_header`  (
  ...
  `applyProtocol` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `eo_api_group_order`  (
  ...
  `orderList` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE TABLE `eo_api_request_param`  (
  `paramID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `paramName` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  ...
  `paramLimit` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `apiID` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `eo_api_request_value`  (
  ...
  `valueDescription` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `eo_api_result_value`  (
  ...
  `valueDescription` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `paramID` int(10) UNSIGNED NOT NULL,
  PRIMARY KEY (`valueID`) USING BTREE,
...
CREATE TABLE `eo_api_test_history`  (
  ...
  `apiID` int(10) UNSIGNED NOT NULL,
  `requestInfo` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `resultInfo` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `testTime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `projectID` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `eo_conn_database`  (
  ...
  `inviteUserID` int(10) NULL DEFAULT NULL,
  `partnerNickName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `eo_conn_project`  (
  ...
  `inviteUserID` int(11) NULL DEFAULT NULL,
  `partnerNickName` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
...
CREATE TABLE `eo_database`  (
  ...
  `dbUpdateTime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
...
CREATE TABLE `eo_database_table`  (
  ...
  `tableDescription` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `eo_database_table_field`  (
  ...
  `fieldDescription` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `eo_message`  (
  ...
  `msgSendTime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  ...
  `otherMsg` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE TABLE `eo_project`  (
  ...
  `projectUpdateTime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
...
CREATE TABLE `eo_project_document`  (
  ...
  `contentRaw` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE TABLE `eo_project_test_case`  (
  ...
  `caseDesc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用例描述',
  ...
  `caseCode` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE TABLE `eo_project_test_case_history`  (
  ...
  `result` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '测试结果',
  `testTime` datetime(0) NULL DEFAULT NULL COMMENT '测试时间',
  `status` tinyint(4) NULL DEFAULT NULL COMMENT '0表示失败，1表示通过',
...
CREATE TABLE `eo_project_test_case_single`  (
  ...
  `caseID` int(11) NOT NULL COMMENT '用例ID',
  `caseData` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '内容',
  `caseCode` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '用例代码',
  `statusCode` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `matchType` tinyint(4) NULL DEFAULT NULL,
  `matchRule` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  ...
  `apiRequestType` tinyint(4) NULL DEFAULT 0 COMMENT '请求参数类型',
